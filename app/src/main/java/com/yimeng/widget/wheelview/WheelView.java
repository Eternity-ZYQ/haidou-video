package com.yimeng.widget.wheelview;
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            ...
            Log.w(TAG, "itemHeight: " + itemHeight);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#FED03C"));
            } else {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#90FED03C"));
