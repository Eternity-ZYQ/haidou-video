...
public class OrederGoodsListAdapter extends BaseAdapter {
    ...
    public OrederGoodsListAdapter(LinkedList<ModelShopOrderListItem> mList, Context mContext,
                                  Handler mHandler, int mWhat, ModelShopOrderList mModelShopOrder) {
        this.mList = mList;
        this.mContext = mContext;
        this.mHandler = mHandler;
        this.mWhat = mWhat;
        this.mModelShopOrder = mModelShopOrder;
    }
    ...
    private void setData(ModelShopOrderListItem model, ViewHolder holder) {
        ...
        holder.clickRL.setTag(mModelShopOrder);
    }
